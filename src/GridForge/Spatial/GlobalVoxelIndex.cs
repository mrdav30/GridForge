...
namespace GridForge.Spatial
{
    ...
    public struct GlobalVoxelIndex
    {
        ...
        /// </summary>
        public VoxelIndex VoxelCoordinates;
        ...
        {
            return $"Index: {GridIndex}; Coordinate: {VoxelCoordinates}";
        }

        /// <summary>
        /// Computes a hash code for uniquely identifying this set of global coordinates.
        /// </summary>
        public override int GetHashCode() => GlobalGridManager.GetSpawnHash(GridSpawnToken, GridIndex, VoxelCoordinates.GetHashCode());
