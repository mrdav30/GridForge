//=======================================================================
// GridBoundaryContactRunStamp.cs
//=======================================================================
...
/// </summary>
public readonly struct GridBoundaryContactRunStamp : IEquatable<GridBoundaryContactRunStamp>
{
    ...
    internal GridBoundaryContactRunStamp(
    ...
    /// <inheritdoc />
    public bool Equals(GridBoundaryContactRunStamp other) =>
    ...
    public override bool Equals(object? obj) =>
        obj is GridBoundaryContactRunStamp other && Equals(other);
    ...
    public static bool operator ==(
        GridBoundaryContactRunStamp left,
        GridBoundaryContactRunStamp right) => left.Equals(right);
